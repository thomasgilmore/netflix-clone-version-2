...
export default function MainMovie(props) {
        return (
          <div className="imageContainer" width="100%" height="600px">
            <LazyLoadImage src={props.smallImage} srcSet={`${props.smallImage} 200w, ${props.mediumImage} 301w, ${props.largeImage} 781w`} alt="Movie or TV Show Back Drop" className="mainMovie" width="100%" max-height="600px" />
