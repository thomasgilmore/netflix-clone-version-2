        ...
        $.ajax({
          ...
          success: (searchResults) => {
            ...
            for (i = 1; i < results.length; i++) {
                ...
                const MovieCard = <MovieCard key={movieId} movieTitle={movieTitle} movieBackdrop={movieBackdrop} />
        ...
        $.ajax({
          ...
          success: (searchResults) => {
            ...
            results.forEach((movie) => {
              ...
              const netflixOriginal = <MovieCard key={movieId} movieTitle={movieTitle} movieBackdrop={moviePoster} />
        ...
        $.ajax({
          ...
          success: (searchResults) => {
            ...
            results.forEach((movie) => {
              ...
              // var moviePoster = "https://image.tmdb.org/t/p/w440_and_h660_face" + movie.poster_path;
              var movieId = movie.id;
              const comedy = <MovieCard key={movieId} movieTitle={movieTitle} movieBackdrop={movieBackdrop} />
        ...
        $.ajax({
          ...
          success: (searchResults) => {
            ...
            results.forEach((movie) => {
              ...
              // var moviePoster = "https://image.tmdb.org/t/p/w440_and_h660_face" + movie.poster_path;
              var movieId = movie.id;
              const drama = <MovieCard key={movieId} movieTitle={movieTitle} movieBackdrop={movieBackdrop} />
              dramas.push(drama)
            })
        ...
        $.ajax({
          ...
          success: (searchResults) => {
            ...
            results.forEach((movie) => {
              ...
              // var moviePoster = "https://image.tmdb.org/t/p/w440_and_h660_face" + movie.poster_path;
              var movieId = movie.id;
              const adventure = <MovieCard key={movieId} movieTitle={movieTitle} movieBackdrop={movieBackdrop} />
        ...
        $.ajax({
          ...
          success: (searchResults) => {
            ...
            results.forEach((movie) => {
              ...
              // var moviePoster = "https://image.tmdb.org/t/p/w440_and_h660_face" + movie.poster_path;
              var movieId = movie.id;
              const tvMovie = <MovieCard key={movieId} movieTitle={movieTitle} movieBackdrop={movieBackdrop} />
